      ...
      <div className="container">
        <div className="flex justify-center items-center pb-base">
          <Link href="/">
            ...
            >
              Aktivferien Travels & Tours
            </h2>
          </Link>
        </div>
        <div className="pt-10 lg:pb-17 pb-12 gradient-border-top flex flex-wrap lg:space-y-0 space-y-8 justify-between ">
          ...
          <div className="contact text-white ">
            ...
            <ul>
              ...
              <li className="mt-5 first:mt-0 flex items-center justify-start  text-stock-1 hover:text-primary-1 duration-200">
                ...
                <Link
                  href={`tel: ${FooterDataOne.whatsapp}`}
                  className="leading-1.5 pl-[10px] text-base "
                >
                  Whatapp no: {FooterDataOne.whatsapp}
                </Link>
              </li>
              <li className="mt-5 first:mt-0 flex items-center justify-start  text-stock-1 hover:text-primary-1 duration-200">
                <div className="flex">
                  ...
                  <div className="flex leading-1.5 pl-[10px] text-base">
                    <h3>Reservation no:</h3>
                    <div className="flex flex-col">
                      <Link
                        href={`tel: ${FooterDataOne.reservation1}`}
                        className="leading-1.5 pl-[10px] text-base "
                      >
                        {FooterDataOne.reservation1}
                      </Link>
                      <Link
                        href={`tel: ${FooterDataOne.reservation2}`}
                        className="leading-1.5 pl-[10px] text-base "
                      >
                        {FooterDataOne.reservation2}
                      </Link>
                    </div>
                  </div>
                </div>
              ...
              <li className="mt-5 first:mt-0 flex items-center justify-start  text-stock-1 hover:text-primary-1 duration-200">
                <div className="text-[20px] text-[#E86042]">
                  <i className="bi bi-person" />
                </div>
                <div className="flex pl-[10px] text-base">
                  <h3>Account no:</h3>
                  <Link
                    href={`tel: ${FooterDataOne.account1}`}
                    className="leading-1.5 pl-[10px] text-base "
                  >
                    {FooterDataOne.account1}
                  </Link>
                  <Link
                    href={`tel: ${FooterDataOne.account2}`}
                    className="leading-1.5 pl-[10px] text-base "
                  >
                    {FooterDataOne.account2}
                  </Link>
                </div>
              </li>
              <li className="mt-5 first:mt-0 flex items-center justify-start text-stock-1 hover:text-primary-1 duration-200">
